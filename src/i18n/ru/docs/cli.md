...
⚠️ Этот флаг генерирует самоподписанный сертификат, вам нужно настроить ваш браузер, чтобы разрешить использование самоподписанных сертификатов для локального хоста.
